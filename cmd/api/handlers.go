...
func (app *application) Home(w http.ResponseWriter, r *http.Request) {
	// JSON response that sends back the status of API
	var payload = struct {
...
// authenticate - handler to authenticate user
func (app *application) authenticate(w http.ResponseWriter, r *http.Request) {
	// read a json payload - properly provided email/password
...
func (app *application) InsertMovie(w http.ResponseWriter, r *http.Request) {
	...
	// Try to Fetch an image from the movieDb-api
...
// AllMoviesByGenre - handler to dislay movies by genre(s)
...
// moviesGraphQL - get the movies via GraphQL
func (app *application) moviesGraphQL(w http.ResponseWriter, r *http.Request) {
	...
	// set the query string on the variable - we receive instructions from the frontend
	g.QueryString = query
